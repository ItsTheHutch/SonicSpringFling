                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                            <div class="videoWrapper">
                                <iframe
                                    src="http://player.twitch.tv/?video=v44292261"
                                    width="100%"
                                    height="auto"
                        ...
                        <div class="col-large-4 col-md-4 col-sm-12 col-xs-12 video-info">
                            <h3>
                            <br>Sonic Spinball</h3>
                            <h3><small>Player</small>
                            <br>JustDaid</h3>
                            <h3><small>Twitch</small>
                                <br><a href="http://twitch.tv/justdaid">twitch.tv/JustDaid</a></h3>
                            <h3><small>Links</small>
                                <br><a href="http://www.twitter.com/justdaid">JustDaid on Twitter</a></h3>
                            <br>
                            <h4>Tackling one of the weirder Sonic games, JustDaid attempts to complete the tough Sonic Spinball!</h4>    
                        </div><!-- end col div -->
                    </div><!-- end row -->
                </div><!-- end container-fluid -->
