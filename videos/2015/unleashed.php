                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                            <div class="videoWrapper">
                                <iframe
                                    src="http://player.twitch.tv/?video=v44292070"
                                    width="100%"
                                    height="auto"
                        ...
                        <div class="col-large-4 col-md-4 col-sm-12 col-xs-12 video-info">
                            <h3>
                            <br>Project Unleashed</h3>
                            <h3><small>Player</small>
                            <br>Wirdjos</h3>
                            <h3><small>Twitch</small>
                                <br><a href="http://twitch.tv/wirdjos">twitch.tv/wirdjos</a></h3>
                            <h3><small>Links</small>
                                <br><a href="http://halfemptyenergytank.com/">Half Empty Energy Tank</a></h3>
                            <br>
                            <h4>We bring the stream back to the HEET hub with former Murder Hobo Wirdjos playing through a Sonic Generations mod, Project Unleashed! All of the best of Unleashed without the werehog!</h4>    
                        </div><!-- end col div -->
                    </div><!-- end row -->
                </div><!-- end container-fluid -->
