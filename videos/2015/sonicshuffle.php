                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                            <div class="videoWrapper">
                                <iframe
                                    src="http://player.twitch.tv/?video=v44292516"
                                    width="100%"
                                    height="auto"
                        ...
                        <div class="col-large-4 col-md-4 col-sm-12 col-xs-12 video-info">
                            ...
                            <br>Bryan, Hutch, Brittany and Soultron</h3>
                            ...
                            <br>
                            <h4>The HEET team scramble to recover from an internet outage! Hutch sobers up and, with the help of TWC, the shuffle continues!</h4>    
                        </div><!-- end col div -->
                    </div><!-- end row -->
                </div><!-- end container-fluid -->
