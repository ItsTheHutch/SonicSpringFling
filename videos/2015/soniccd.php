                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                            <div class="videoWrapper">
                                <iframe
                                    src="http://player.twitch.tv/?video=v44292369"
                                    width="100%"
                                    height="auto"
                        ...
                        <div class="col-large-4 col-md-4 col-sm-12 col-xs-12 video-info">
                            ...
                            <h3><small>Twitch</small>
                                <br><a href="http://twitch.tv/lucasvogler">twitch.tv/LucasVogler</a></h3>
                            <br>
                            <h4>As the early morning block begins, we cut to Lucas who plays through Sonic CD!</h4>    
                        </div><!-- end col div -->
                    </div><!-- end row -->
                </div><!-- end container-fluid -->
