                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                            <div class="videoWrapper">
                                <iframe
                                    src="http://player.twitch.tv/?video=v44291405"
                                    width="100%"
                                    height="auto"
                        ...
                        <div class="col-large-4 col-md-4 col-sm-12 col-xs-12 video-info">
                            <h3>
                            <br>Sonic The Hedgehog 3 &amp; Knuckles</h3>
                            <h3><small>Player</small>
                            <br>Bryan Belcher &amp; ItsTheHutch</h3>
                            <h3><small>Twitch</small>
                                <br><a href="http://twitch.tv/halfemptyenergytank">twitch.tv/HalfEmptyEnergyTank</a>
                            ...
                            <br>
                            <h4>Bryan has finally had enough.  He's playing Sonic 3 &amp; Knuckles, but he'll need some help.  Luckily, Hutch will answer the call.</h4>    
                        </div><!-- end col div -->
                    </div><!-- end row -->
                </div><!-- end container-fluid -->
