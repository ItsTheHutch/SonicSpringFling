                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                            <div class="videoWrapper">
                                <iframe
                                    src="http://player.twitch.tv/?video=v44292559"
                                    width="100%"
                                    height="auto"
                        ...
                        <div class="col-large-4 col-md-4 col-sm-12 col-xs-12 video-info">
                            <h3>
                            <br>The Blast Processors live performance</h3>
                            <h3><small>Player</small>
                            <br>The Blast Processors</h3>
                            <h3><small>Twitter</small>
                                <br><a href="http://twitter.com/BlastProcessors">twitter.com/BlastProcessors</a></h3>
                            <h3><small>Links</small>
                                <br><a href="http://blastprocessors.bandcamp.com/">The Blast Processors on Bandcamp</a>
                                <br><a href="http://www.blastprocessors.com/">BlastProcessors.com</a>
                                </h3>
                            <br>
                            <h4>The Blast Processors rock out with some awesome Genesis inspired tracks!</h4>    
                        </div><!-- end col div -->
                    </div><!-- end row -->
                </div><!-- end container-fluid -->
