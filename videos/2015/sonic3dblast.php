                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                            <div class="videoWrapper">
                                <iframe
                                    src="http://player.twitch.tv/?video=v44292160"
                                    width="100%"
                                    height="auto"
                        ...
                        <div class="col-large-4 col-md-4 col-sm-12 col-xs-12 video-info">
                            <h3>
                            <br>Sonic 3D Blast</h3>
                            <h3><small>Player</small>
                            <br>Hotsammysliz</h3>
                            <h3><small>Twitch</small>
                                <br><a href="http://twitch.tv/hotsammysliz">twitch.tv/Hotsammysliz</a></h3>
                            <h3><small>Links</small>
                                <br><a href="http://www.patreon.com/hotsammysliz">Hotsammysliz on Patreon</a>
                                <br><a href="http://www.twitter.com/hotsammysliz">Hotsammysliz on Twitter</a></h3>
                            <br>
                            <h4>The SWEG KNIGHT himself takes over to play Sonic 3D Blast, grabbing all of the emeralds in the process!</h4>    
                        </div><!-- end col div -->
                    </div><!-- end row -->
                </div><!-- end container-fluid -->
