                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                            <div class="videoWrapper">
                                <iframe
                                    src="http://player.twitch.tv/?video=v44293311"
                                    width="100%"
                                    height="auto"
                        ...
                        <div class="col-large-4 col-md-4 col-sm-12 col-xs-12 video-info">
                            <h3>
                            <br>D&amp;D Sluggers live performance</h3>
                            <h3><small>Player</small>
                            <br>D&amp;D Sluggers</h3>
                            <h3><small>Twitch</small>
                                <br><a href="http://twitch.tv/ddsluggers">twitch.tv/ddsluggers</a></h3>
                            <h3><small>Links</small>
                                <br><a href="http://ddsluggers.com/">D&amp;DSluggers.com</a>
                                <br><a href="http://ddsluggers.bandcamp.com/">D&amp;D Sluggers on Bandcamp</a>
                                </h3>
                            <br>
                            <h4>D&amp;D Sluggers aka Soultron aka Tim performs live!</h4>    
                        </div><!-- end col div -->
                    </div><!-- end row -->
                </div><!-- end container-fluid -->
