                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                            <div class="videoWrapper">
                                <iframe
                                    src="http://player.twitch.tv/?video=v44291046"
                                    width="100%"
                                    height="auto"
                        ...
                        <div class="col-large-4 col-md-4 col-sm-12 col-xs-12 video-info">
                            <h3>
                            <br>Sonic Generations</h3>
                            <h3><small>Player</small>
                            <br>Hawkfoot718</h3>
                            <h3><small>Twitch</small>
                                <br><a href="http://twitch.tv/hawkfoot718">twitch.tv/Hawkfoot718</a></h3>
                            <h3><small>Links</small>
                                <br><a href="http://twitter.com/hawkfoot718">Hawkfoot718 on Twitter</a>
                                <br><a href="http://halfemptyenergytank.com/">Half Empty Energy Tank</a></h3>
                            <br>
                            <h4>Hawkfoot gives the guys at the HEET hub one last break as he plays Sonic Generations!</h4>    
                        </div><!-- end col div -->
                    </div><!-- end row -->
                </div><!-- end container-fluid -->
