                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                            <div class="videoWrapper">
                                <iframe
                                    src="http://player.twitch.tv/?video=v44293326"
                                    width="100%"
                                    height="auto"
                        ...
                        <div class="col-large-4 col-md-4 col-sm-12 col-xs-12 video-info">
                            <h3>
                            <br>Dj CUTMAN live performance</h3>
                            <h3><small>Player</small>
                            <br>Dj CUTMAN</h3>
                            <h3><small>Twitch</small>
                                <br><a href="http://twitch.tv/djcutman">twitch.tv/djcutman</a></h3>
                            <h3><small>Links</small>
                                <br><a href="http://www.videogamedj.com/">Videogamedj.com</a>
                                <br><a href="http://www.gamechops.com/">GameChops</a>
                                </h3>
                            <br>
                            <h4>Dj CUTMAN performs an amazing set of Sonic remixes!</h4>    
                        </div><!-- end col div -->
                    </div><!-- end row -->
                </div><!-- end container-fluid -->
