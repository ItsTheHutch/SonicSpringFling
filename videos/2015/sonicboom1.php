                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                            <div class="videoWrapper">
                                <iframe
                                    src="http://player.twitch.tv/?video=v44290615"
                                    width="100%"
                                    height="auto"
                        ...
                        <div class="col-large-4 col-md-4 col-sm-12 col-xs-12 video-info">
                            <h3>
                            <br>Sonic Boom: Rise of Lyric pt. 1</h3>
                            ...
                            <br>
                            <h4>Hutch plays through Sonic Boom, everyone's favorite Sonic theme song, but maybe not Sonic game?  Either way, we hit our goal by the end of it, so success!  The stream unfortunately cut out a few times, so this game is in 3 parts.</h4>    
                        </div><!-- end col div -->
                    </div><!-- end row -->
                </div><!-- end container-fluid -->
