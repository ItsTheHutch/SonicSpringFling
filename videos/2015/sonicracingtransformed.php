                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                            <div class="videoWrapper">
                                <iframe
                                    src="http://player.twitch.tv/?video=v44292450"
                                    width="100%"
                                    height="auto"
                        ...
                        <div class="col-large-4 col-md-4 col-sm-12 col-xs-12 video-info">
                            <h3>
                            <br>Sonic & Sega All Stars Racing Transformed</h3>
                            <h3><small>Player</small>
                            <br>Pixelkaye</h3>
                            <h3><small>Twitch</small>
                                <br><a href="http://twitch.tv/pixelkaye">twitch.tv/Pixelkaye</a></h3>
                            <h3><small>Links</small>
                                <br><a href="http://twitter.com/">Pixelkaye on Twitter</a></h3>
                            <br>
                            <h4>The internet at the house cuts out!  Luckily, Pixelkaye is there to help keep things moving with some racing action!</h4>    
                        </div><!-- end col div -->
                    </div><!-- end row -->
                </div><!-- end container-fluid -->
